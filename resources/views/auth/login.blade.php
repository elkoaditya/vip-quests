...
<head>
    ...
    <link rel="stylesheet" href="{{asset('material')}}/vendor/libs/typeahead-js/typeahead.css" />
    <!-- Vendor -->
    <link rel="stylesheet" href="{{asset('material')}}/vendor/libs/formvalidation/dist/css/formValidation.min.css" />

    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{asset('material')}}/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
        ...
        <div class="authentication-inner py-4">
            ...
            <div class="card p-2">
                ...
                <div class="card-body mt-2">
                    ...
                    <form id="" class="mb-3" action="/login" method="POST" novalidate>@csrf
            ...
            <img
                alt="mask"
                src="{{asset('material')}}/img/illustrations/auth-basic-login-mask-light.png"
...
<script src="{{asset('material')}}/vendor/libs/i18n/i18n.js"></script>
<script src="{{asset('material')}}/vendor/libs/typeahead-js/typeahead.js"></script>

<script src="{{asset('material')}}/vendor/js/menu.js"></script>
<!-- endbuild -->

<!-- Vendors JS -->
<script src="{{asset('material')}}/vendor/libs/formvalidation/dist/js/FormValidation.min.js"></script>
<script src="{{asset('material')}}/vendor/libs/formvalidation/dist/js/plugins/Bootstrap5.min.js"></script>
<script src="{{asset('material')}}/vendor/libs/formvalidation/dist/js/plugins/AutoFocus.min.js"></script>

<!-- Main JS -->
<script src="{{asset('material')}}/js/main.js"></script>

<!-- Page JS -->
<script src="{{asset('material')}}/js/pages-auth.js"></script>
</body>
</html>
